...
A little while later, Chrome finished downloading and opened just fine.

But did you really *just* have to type "bilibili" straight into the search bar[^1]—

[^1]: Chrome's default search engine is Google, which can't be accessed directly from Chinese mainland.

bro tried hitting Google directly from Chinese mainland 💀

If only you knew the [Bilibili URL](https://www.bilibili.com)

If only you knew that most Google services are blocked over here

And even setting all that aside—

**If only you'd downloaded Edge, of all things?!**[^2]
...
Me? Saving my strength! I just wanna be an NPC, so please don't pressure me (panicking (jk)
