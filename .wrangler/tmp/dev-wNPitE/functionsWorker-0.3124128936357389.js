...
// .wrangler/tmp/pages-Zv4DhA/functionsWorker-0.3124128936357389.mjs
...
__name2(sanitizeKey, "sanitizeKey");
...
__name2(getVisitorId, "getVisitorId");
...
__name(json, "json");
__name2(json, "json");
var onRequestGet = /* @__PURE__ */ __name2(async ({ params, env, request }) => {
...
var onRequestPost = /* @__PURE__ */ __name2(async ({ params, env, request }) => {
  const slug = sanitizeKey(getSlug(params));
  const headers = new Headers();
  const visitorId = await getVisitorId(request, headers);
...
// .wrangler/tmp/bundle-GYzVyZ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-GYzVyZ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3124128936357389.js.map
